...
class PromptBuilders(
    ...
    fun buildPrompt(idx: Int): String = buildString {
        ...
        appendLine("Create a file named `$stepFile` containing only this step's data. Use the heading `## Step ${idx + 1} — ${questionLabel(q)}`. Save via Claude's file-creation tools.")
